...
export function AllScreensGrid({ onSelectScreen }: AllScreensGridProps) {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto px-6 py-6 space-y-8">
      {/* Header */}
      <div className="bg-white rounded-[6px] border border-slate-200/90 p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)] flex items-center justify-between">
        <div>
          <h1 className="!text-base !font-bold !text-slate-900 !m-0">
