...
export function TimeTrackerToolbar({
  ...
  return (
    <div className="bg-white/95 backdrop-blur-md pt-3 pb-3 border-b border-slate-200/90 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 shadow-[0_1px_2px_rgba(0,0,0,0.03)] w-full px-4 sm:px-6">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
        ...
        <div className="flex items-center bg-white border border-slate-200 rounded px-2 py-1 shadow-xs text-xs font-semibold text-slate-700">
          ...
          <div className="flex items-center gap-1.5 px-2 text-slate-800 font-bold">
            <svg
              className="h-3.5 w-3.5 text-slate-400 hidden xs:block"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
        ...
        <div className="hidden sm:flex items-center bg-white border border-slate-200 rounded shadow-xs overflow-hidden">
          ...
          <button
            className="p-1.5 text-slate-400 hover:text-slate-700 border-l border-slate-200 cursor-pointer"
            title="Calendar View"
          >
            <svg
              className="h-4 w-4"
