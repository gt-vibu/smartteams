        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              ...
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.employeeNumber}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              <span className="text-slate-500 font-medium block">Full Name</span>
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.firstName} {employee.lastName}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
            ...
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              ...
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.department}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              <span className="text-slate-500 font-medium block">Work Email</span>
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.workEmail}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              <span className="text-slate-500 font-medium block">Contact Phone</span>
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.phone || '+91 98765 43210'}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              <span className="text-slate-500 font-medium block">Work Location</span>
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.location || 'Bangalore, India'}</span>
            </div>
            <div className="bg-slate-50 p-3 rounded border border-slate-200/70">
              <span className="text-slate-500 font-medium block">Date of Joining</span>
              <span className="font-semibold text-slate-900 mt-0.5 block">{employee.joinedDate || '15-Jan-2024'}</span>
            </div>
          </div>
        </div>
