...
| PostgreSQL | `DATABASE_URL`, `DATABASE_SYSTEM_URL`, `DATABASE_PLATFORM_URL`, optional `DATABASE_MIGRATION_URL` | API runtime, system workers, platform operations, Prisma CLI | Yes; the first three must be distinct outside development |
